...
------------|--------------
A7, A8 <br> D5, D3| Available ARDUINO analog GPIO / DIGITAL GPIO  <br> Available ARDUINO digital GPIO <br> check picture <br> ![](https://github.com/EasySensors/WallSocketInsertableNode/blob/master/pics/Pins.jpg?raw=true)
